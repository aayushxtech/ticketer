...
export default function SeatGrid({ seats, selectedIds, onToggle }) {
  if (!seats || seats.length === 0) return <p className="empty">No seats available.</p>;

  // Backend returns flat seats: { id, seat_number, is_booked }
  // Arrange into a grid: ~10 seats per row (adjustable)
